...
_ALIGNMENT_TIERS: list[tuple[float, str]] = [
    ...
    (
        MARKET_ALIGNMENT_THRESHOLD,
        "Discrepancia moderada — revisar supuestos de forma o contexto",
    ),
...
def ajustar_knowledge_pack(
    ...
    specs = [
        ...
        (
            "shots_on_target_ou",
            "shots_on_target_ou",
            xvol.get("shots_on_target_total"),
            1.4,
        ),
    ...
    if alignments:
        ...
        market_signal["global_alignment"] = {
            ...
            "interpretacion": next(
                t for thresh, t in _GLOBAL_ALIGNMENT_TIERS if global_alignment >= thresh
            ),
        }
