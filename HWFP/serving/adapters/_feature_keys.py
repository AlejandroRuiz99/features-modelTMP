...
dict for ensemble.predict(). String fields (home_team, away_team, referee,
season, date, intensidad_esperada, riesgo_disciplinario) are excluded — they
are reconstructed with defaults in PyTorchFoulModel.
"""
