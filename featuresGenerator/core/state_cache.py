...
from core.utils import classify_competition, parse_date_safe, fuzzy_name_search, TEAM_ALIASES
...
def _build_team_match_index(
    ...
    for row in calendar_rows:
        md = parse_date_safe(row.get("match_date"))
        if md is None:
            continue
...
def build_state(
    ...
    *,
    ...
    cal_index = _build_team_match_index(calendar_rows, canonical_teams) if calendar_rows else {}
