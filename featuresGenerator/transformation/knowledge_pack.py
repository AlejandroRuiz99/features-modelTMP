...
_NEUTRAL_CTX = {
    "local":     {"factors": _NEUTRAL_FACTORS, "scores": {"icc": None}, "lectura": "sin datos"},
    "visitante": {"factors": _NEUTRAL_FACTORS, "scores": {"icc": None}, "lectura": "sin datos"},
}
...
def ensamblar_knowledge_pack(
    ...
    contexto_comp: Optional[dict] = None,
) -> dict:
    ...
    xtarjetas       = calcular_xtarjetas(xfouls_result, xstyles, equipo_local, equipo_visitante, ref_perfiles, arbitro)
    ...
    xgoals_adj = {
        "xg_local": xg_l_adj, "xg_visitante": xg_v_adj,
    ...
    xtarjetas_adj = {
        **xtarjetas,
        ...
        "xtarjetas_total":      round(xtarjetas["xtarjetas_local"] * ratio_l + xtarjetas["xtarjetas_visitante"] * ratio_v, 2),
        ...
        "xamarillas_total":     round(xtarjetas["xamarillas_local"] * ratio_l + xtarjetas["xamarillas_visitante"] * ratio_v, 2),
    }
    ...
    narrative = generar_narrative(
        equipo_local, equipo_visitante, forma_local, forma_visitante,
        xgoals_adj, xposesion_adj, xtarjetas_adj, xfouls_adj,
        agresividad_vol, ctx, compat, contexto,
    )
