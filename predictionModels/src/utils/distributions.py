...
class FoulPMF:
    ...
    def over_under_table(self, lines: Optional[list[float]] = None) -> dict[float, tuple[float, float]]:
    ...
    def interval_table(self, breakpoints: Optional[list[int]] = None) -> dict[str, float]:
...
def tilt_pmf_to_mean(base_pmf: FoulPMF, target_mean: float, max_iter: int = 80) -> FoulPMF:
    """
